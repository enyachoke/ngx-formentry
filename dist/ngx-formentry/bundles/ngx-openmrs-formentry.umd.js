(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-bootstrap/collapse'), require('hammerjs'), require('rxjs/operators'), require('@ng-select/ng-select'), require('ngx-file-uploader-ampath'), require('@angular/platform-browser'), require('@angular/material/datepicker'), require('@angular/material/form-field'), require('@angular/material'), require('@angular/material/core'), require('@angular/material-moment-adapter'), require('@angular/material/select'), require('rxjs'), require('moment'), require('lodash'), require('@angular/http'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-openmrs-formentry', ['exports', 'ngx-bootstrap/collapse', 'hammerjs', 'rxjs/operators', '@ng-select/ng-select', 'ngx-file-uploader-ampath', '@angular/platform-browser', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material', '@angular/material/core', '@angular/material-moment-adapter', '@angular/material/select', 'rxjs', 'moment', 'lodash', '@angular/http', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global['ngx-openmrs-formentry'] = {}),global.collapse,null,global.rxjs.operators,global.ngSelect,global.ngxFileUploaderAmpath,global.ng.platformBrowser,global.ng.material.datepicker,global.ng.material['form-field'],global.ng.material,global.ng.material.core,global.ng['material-moment-adapter'],global.ng.material.select,global.rxjs,global.moment_,global._,global.ng.http,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,collapse,hammerjs,operators,ngSelect,ngxFileUploaderAmpath,platformBrowser,datepicker,formField,material,core,materialMomentAdapter,select,rxjs,moment_,_,http,common,core$1,forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormRendererComponent = /** @class */ (function () {
        function FormRendererComponent(validationFactory, dataSources, formErrorsService, document) {
            ...
            this.locationsInput$ = new rxjs.Subject();
            this.activeTab = 0;
        }
        /**
         * @return {?}
         ...
         */
            function () {
                ...
                if (this.node && this.node.question.extras &&
                    ...
                    this.locations$ = rxjs.concat(defaltValues, this.locationsInput$.pipe(operators.debounceTime(200), operators.distinctUntilChanged(), operators.tap(function () { return _this.locationsLoading = true; }), operators.switchMap(function (term) {
